...
<body>
    <div class="wrap">
        ...
        <div class="content">
            <p>مرحبًا،</p>
            <p>لقد وصلنا طلب لإعادة تعيين كلمة المرور الخاصة بحسابك على {{ config('app.name') }}.</p>
            <p>يمكنك تعيين كلمة مرور جديدة من خلال الضغط على الزر التالي:</p>
            <p>
                <a href="{{ $resetUrl }}" class="btn" target="_blank" rel="noopener">تعيين كلمة مرور جديدة</a>
            </p>
            <p class="muted">أو قم بنسخ الرابط التالي ولصقه في المتصفح:</p>
            <p class="muted" style="direction:ltr; text-align:left; word-break: break-all;">{{ $resetUrl }}</p>
            <p class="muted">صلاحية هذا الرابط لمدة 60 دقيقة فقط.</p>
            <p>إذا لم تطلب إعادة تعيين كلمة المرور، يمكنك تجاهل هذه الرسالة ولن يتم إجراء أي تغيير.</p>
            <p>مع خالص التحية،<br>{{ config('app.name') }}</p>
        </div>
